...
public interface UploadVideoWithRecorderService {
	 ...
	 */
	public abstract QueryVideoIDorWatermarkIDParam uploadVideoWithRecorder(String filePath,
			Map<String, Object> initParamMap, Map<String, Object> recoderMap)
			throws IOException, VcloudException;

	/**
	 * 
	 * <p>Title: upload_First</p>
	 * <p>Description: 第一次上传视频</p>
	 * @param recoderMap     记录视频上传参数的集合，用于存储断点续传所需的相关参数
	 * @param filePath       上传文件路径
	 * @param initParamMap   初始化参数集合
	 * @return  视频上传成功，则返回根据对象名查询视频ID输出参数的封装类，否则返回null
	 ...
	 * @throws VcloudException
	 */
	public abstract QueryVideoIDorWatermarkIDParam uploadFirst(
			Map<String, Object> recoderMap, String filePath,
	 ...
	 * @throws VcloudException
	 */
	public abstract QueryVideoIDorWatermarkIDParam uploadAgain(
			Map<String, Object> recoderMap, String filePath,
