...
* <p>Description:  创建转码模板输出参数中ret部分的封装类</p>
...
public class InitUploadVideoRet {
	...
	* <p>Description: 得到创建转码模板输出参数中ret部分的上传的token信息</p>
	* @return 上传的token信息
	 */
	...
	* <p>Description: 设置创建转码模板输出参数中ret部分的上传的token信息</p>
	* @param xNosToken 上传的token信息
	 ...
	 * 
	* <p>Title: getBucket</p>
	* <p>Description: 得到创建转码模板输出参数中ret部分的存储上传文件的桶名</p>
	* @return 存储上传文件的桶名
	 */
	 ...
	 * 
	* <p>Title: setBucket</p>
	* <p>Description: 设置创建转码模板输出参数中ret部分的存储上传文件的桶名</p>
	* @param bucket 存储上传文件的桶名
	 ...
	 * 
	* <p>Title: getObject</p>
	* <p>Description: 得到创建转码模板输出参数中ret部分的存储上传文件的对象名</p>
	* @return 存储上传文件的对象名
	 */
	 ...
	 * 
	* <p>Title: setObject</p>
	* <p>Description: 设置创建转码模板输出参数中ret部分的存储上传文件的对象名</p>
